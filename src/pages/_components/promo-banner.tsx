// Renders an admin-created coupon banner (HTML) for a given placement, or nothing if there's
// no live banner there. Used on the top bar, hero, shop, checkout and as a popup.
...
export default function PromoBanner({ placement, className }: { placement: PromoBannerType["placement"]; className?: string }) {
  ...
  const content = <div dangerouslySetInnerHTML={{ __html: banner.html }} />;
