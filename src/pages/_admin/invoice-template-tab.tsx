...
const PLACEHOLDER_HELP =
  "{{brand}} {{address}} {{gstin}} {{invoice_number}} {{invoice_date}} {{order_id}} {{customer_name}} {{phone}} {{customer_address}} {{items_rows}} {{subtotal}} {{coupon_code}} {{discount}} {{total}} {{payment_id}}";
